...
public:
	...
	float EPA_GJK(CollisionPair pair, glm::vec3 &coll_normal, glm::vec3 &pointA, glm::vec3 &pointB, std::vector<glm::vec3> &a_tri, std::vector<glm::vec3> &b_tri, float dt);
	...
	void backtrack(CollisionPair &pair, float dt, float threshold, float distance, std::vector<SupportPoint> &new_sim, glm::vec3 &new_contact_point, glm::vec3 &new_contact_normal);
	float EPA_GJK_bt(CollisionPair pair, glm::vec3 &coll_normal, glm::vec3 &pointA, glm::vec3 &pointB, std::vector<glm::vec3> &a_tri, std::vector<glm::vec3> &b_tri, float dt);
};
